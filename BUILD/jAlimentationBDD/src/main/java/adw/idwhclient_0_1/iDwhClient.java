...
/**
 * Job: iDwhClient Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class iDwhClient implements TalendJob {
...
public String getSchema_param(){
	...
	private final String jobName = "iDwhClient";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(iDwhClient.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ADW_iDwhClient = new byte[0];
    static byte[] commonByteArray_ADW_iDwhClient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADW_iDwhClient.length) {
				if(length < 1024 && commonByteArray_ADW_iDwhClient.length == 0) {
   					commonByteArray_ADW_iDwhClient = new byte[1024];
				} else {
   					commonByteArray_ADW_iDwhClient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADW_iDwhClient, 0, length);
			strReturn = new String(commonByteArray_ADW_iDwhClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ADW_iDwhClient, 0, length);
			strReturn = new String(commonByteArray_ADW_iDwhClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADW_iDwhClient) {
 ...
 */
	...
	final String decryptedPassword_Implicit_Context_Database = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:eNsRQJ4C9eMguK3ZX0Q4dPllj6gqYMDg/7fKdovqQ44NRbAn");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(clients,row3) outputs:(insertClient,updateBLcurrent,insertNewClient)
 ...
 */
    ...
    public static void main(String[] args){
        final iDwhClient iDwhClientClass = new iDwhClient();

        int exitCode = iDwhClientClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = iDwhClient.class.getClassLoader().getResourceAsStream("adw/idwhclient_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = iDwhClient.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : iDwhClient");
        }
...
/************************************************************************************************
 *     259366 characters generated by Talend Open Studio for Data Integration 
