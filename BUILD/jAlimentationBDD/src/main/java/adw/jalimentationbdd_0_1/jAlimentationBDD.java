...
package adw.jalimentationbdd_0_1;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ADW_jAlimentationBDD = new byte[0];
    static byte[] commonByteArray_ADW_jAlimentationBDD = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADW_jAlimentationBDD.length) {
				if(length < 1024 && commonByteArray_ADW_jAlimentationBDD.length == 0) {
   					commonByteArray_ADW_jAlimentationBDD = new byte[1024];
				} else {
   					commonByteArray_ADW_jAlimentationBDD = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADW_jAlimentationBDD, 0, length);
			strReturn = new String(commonByteArray_ADW_jAlimentationBDD, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ADW_jAlimentationBDD, 0, length);
			strReturn = new String(commonByteArray_ADW_jAlimentationBDD, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADW_jAlimentationBDD) {
 ...
 */
	...
	final String decryptedPassword_Implicit_Context_Database = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:LJAbt6dMNcz3j61KcDw9yOv62UtzM1XX6NoSQb+FwBMDzLmy");
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		adw.jchargeods_0_1.jChargeODS childJob_tRunJob_1 = new adw.jchargeods_0_1.jChargeODS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		adw.jchargedwh_0_1.jChargeDWH childJob_tRunJob_2 = new adw.jchargedwh_0_1.jChargeDWH();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jAlimentationBDD.class.getClassLoader().getResourceAsStream("adw/jalimentationbdd_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     112028 characters generated by Talend Open Studio for Data Integration 
