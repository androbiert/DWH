...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ADW_jChargeDWH = new byte[0];
    static byte[] commonByteArray_ADW_jChargeDWH = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADW_jChargeDWH.length) {
				if(length < 1024 && commonByteArray_ADW_jChargeDWH.length == 0) {
   					commonByteArray_ADW_jChargeDWH = new byte[1024];
				} else {
   					commonByteArray_ADW_jChargeDWH = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADW_jChargeDWH, 0, length);
			strReturn = new String(commonByteArray_ADW_jChargeDWH, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ADW_jChargeDWH, 0, length);
			strReturn = new String(commonByteArray_ADW_jChargeDWH, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADW_jChargeDWH) {
 ...
 */
	...
	final String decryptedPassword_Implicit_Context_Database = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:OjMGmN4x8Vsvt0Yv2Q2uUPGpgeY1udqY3xOXd82hMnJO2tmO");
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		adw.jdwhproduit_0_1.jDwhProduit childJob_tRunJob_3 = new adw.jdwhproduit_0_1.jDwhProduit();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		adw.idwhclient_0_1.iDwhClient childJob_tRunJob_1 = new adw.idwhclient_0_1.iDwhClient();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		adw.jdwhvente_0_1.jDwhVente childJob_tRunJob_6 = new adw.jdwhvente_0_1.jDwhVente();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jChargeDWH.class.getClassLoader().getResourceAsStream("adw/jchargedwh_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     121366 characters generated by Talend Open Studio for Data Integration 
