...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ADW_jChargeODS = new byte[0];
    static byte[] commonByteArray_ADW_jChargeODS = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADW_jChargeODS.length) {
				if(length < 1024 && commonByteArray_ADW_jChargeODS.length == 0) {
   					commonByteArray_ADW_jChargeODS = new byte[1024];
				} else {
   					commonByteArray_ADW_jChargeODS = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADW_jChargeODS, 0, length);
			strReturn = new String(commonByteArray_ADW_jChargeODS, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ADW_jChargeODS, 0, length);
			strReturn = new String(commonByteArray_ADW_jChargeODS, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADW_jChargeODS) {
 ...
 */
	...
	final String decryptedPassword_Implicit_Context_Database = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:9cldLo/8G9ch9hHc/tA3333AXaJ5YS2v+m0FcN4nKFhd1bf0");
 ...
 */
	...
	System.err.println("Le repertoire de " +TalendDate.getDate("YYYYMMDD") + "n'existe pas "  );
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Le repertoire de " +TalendDate.getDate("YYYYMMDD") + "n'existe pas "  );
	globalMap.put("tDie_1_DIE_MESSAGES", "Le repertoire de " +TalendDate.getDate("YYYYMMDD") + "n'existe pas "  );
...
// Convertir durée en millisecondes → hh:mm:ss
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_7 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_7 {
                    ...
                    parentContextMap_tRunJob_7.put("additionalParam", context.additionalParam);
                    paraList_tRunJob_7.add("--context_type " + "additionalParam" + "=" + "id_String");
                    ...
                    paraList_tRunJob_7.add("--context_type " + "password" + "=" + "id_Password");
                    parentContextMap_tRunJob_7.put("port", context.port);
                    paraList_tRunJob_7.add("--context_type " + "port" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("schema_ods", context.schema_ods);
                    paraList_tRunJob_7.add("--context_type " + "schema_ods" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("serverName", context.serverName);
                    paraList_tRunJob_7.add("--context_type " + "serverName" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("utilisateur", context.utilisateur);
                    paraList_tRunJob_7.add("--context_type " + "utilisateur" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("schema_param", context.schema_param);
                    paraList_tRunJob_7.add("--context_type " + "schema_param" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("encodage", context.encodage);
                    paraList_tRunJob_7.add("--context_type " + "encodage" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("fieldSeparator", context.fieldSeparator);
                    paraList_tRunJob_7.add("--context_type " + "fieldSeparator" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("projectFolder", context.projectFolder);
                    paraList_tRunJob_7.add("--context_type " + "projectFolder" + "=" + "id_Directory");
                        }
	...
	Object obj_tRunJob_7 = null;
		...
		adw.jodscategorie_0_1.jOdsCategorie childJob_tRunJob_7 = new adw.jodscategorie_0_1.jOdsCategorie();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		adw.jodssouscategorie_0_1.jOdsSousCategorie childJob_tRunJob_2 = new adw.jodssouscategorie_0_1.jOdsSousCategorie();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		adw.jodsproduit_0_1.jOdsProduit childJob_tRunJob_3 = new adw.jodsproduit_0_1.jOdsProduit();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		adw.odstypeclient_0_1.OdsTypeClient childJob_tRunJob_4 = new adw.odstypeclient_0_1.OdsTypeClient();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		adw.jodsclient_0_1.jOdsClient childJob_tRunJob_5 = new adw.jodsclient_0_1.jOdsClient();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		adw.jodsvente_0_1.jOdsVente childJob_tRunJob_6 = new adw.jodsvente_0_1.jOdsVente();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jChargeODS.class.getClassLoader().getResourceAsStream("adw/jchargeods_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     158143 characters generated by Talend Open Studio for Data Integration 
