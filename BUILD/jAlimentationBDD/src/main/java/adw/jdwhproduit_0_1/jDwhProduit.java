...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ADW_jDwhProduit = new byte[0];
    static byte[] commonByteArray_ADW_jDwhProduit = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADW_jDwhProduit.length) {
				if(length < 1024 && commonByteArray_ADW_jDwhProduit.length == 0) {
   					commonByteArray_ADW_jDwhProduit = new byte[1024];
				} else {
   					commonByteArray_ADW_jDwhProduit = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADW_jDwhProduit, 0, length);
			strReturn = new String(commonByteArray_ADW_jDwhProduit, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ADW_jDwhProduit, 0, length);
			strReturn = new String(commonByteArray_ADW_jDwhProduit, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADW_jDwhProduit) {
 ...
 */
	...
	final String decryptedPassword_Implicit_Context_Database = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Y6FcYDLDHy0ZrDEXuo0LSQRuClO30C9A4mUTzXvhPNVuY4FS");
...
// Formattage manuel de la durée
long duration = (Long) globalMap.get("tChronometerStop_1_DURATION");
...
public static class insertProduitDWHStruct implements routines.system.IPersistableRow<insertProduitDWHStruct> {
    final static byte[] commonByteArrayLock_ADW_jDwhProduit = new byte[0];
    static byte[] commonByteArray_ADW_jDwhProduit = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final insertProduitDWHStruct other = (insertProduitDWHStruct) obj;
	...
	public void copyDataTo(insertProduitDWHStruct other) {
	...
	public void copyKeysDataTo(insertProduitDWHStruct other) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DT_INSERTION = readDate(dis);
						...
						this.BL_LIGNE_ACTIVE = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.BL_LIGNE_ACTIVE,dos);
     ...
     * Compare keys
     */
    public int compareTo(insertProduitDWHStruct other) {
...
public static class produitsToInsertStruct implements routines.system.IPersistableRow<produitsToInsertStruct> {
    final static byte[] commonByteArrayLock_ADW_jDwhProduit = new byte[0];
    static byte[] commonByteArray_ADW_jDwhProduit = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(produitsToInsertStruct other) {
...
produitsToInsertStruct produitsToInsert = new produitsToInsertStruct();
insertProduitDWHStruct insertProduitDWH = new insertProduitDWHStruct();
...
insertNewProduitStruct insertNewProduit = new insertNewProduitStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertProduitDWH");
					}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"CD_PRODUIT\",\"NOM_PRODUIT\",\"PRIX_ACHAT_PRODUIT\",\"PRIX_VENTE_PRODUIT\",\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"LB_CATEGORIE\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\",\"CD_CATEGORIE\") VALUES (?,?,?,?,?,?,?,?,?,?,?)";
...
int count_tDBOutput_3=0;
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"CD_PRODUIT\",\"NOM_PRODUIT\",\"PRIX_ACHAT_PRODUIT\",\"PRIX_VENTE_PRODUIT\",\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"LB_CATEGORIE\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tMap_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"produitsToInsert");
					}
...
insertProduitDWHStruct insertProduitDWH_tmp = new insertProduitDWHStruct();
...
// ###############################
// # Outputs initialization
produitsToInsertStruct produitsToInsert_tmp = new produitsToInsertStruct();
// ###############################
...
produitsToInsert = null;

if(!rejectedInnerJoin_tMap_1 ) {

// # Output table : 'produitsToInsert'
produitsToInsert_tmp.CD_PRODUIT = row1.CD_PRODUIT ;
produitsToInsert_tmp.NOM_PRODUIT = row1.NOM_PRODUIT ;
produitsToInsert_tmp.PRIX_ACHAT_PRODUIT = row1.PRIX_ACHAT_PRODUIT ;
produitsToInsert_tmp.PRIX_VENTE_PRODUIT = row1.PRIX_VENTE_PRODUIT ;
produitsToInsert_tmp.CD_SOUS_CATEGORIE = row1.CD_SOUS_CATEGORIE ;
produitsToInsert_tmp.LB_SOUS_CATEGORIE = row2.LB_SOUS_CATEGORIE ;
produitsToInsert_tmp.LB_CATEGORIE = row3.LB_CATEGORIE ;
produitsToInsert_tmp.LB_JOB_NAME = jobName;
produitsToInsert_tmp.CD_CATEGORIE = row2.CD_CATEGORIE ;
produitsToInsert = produitsToInsert_tmp;
 ...
 */
// Start of branch "produitsToInsert"
if(produitsToInsert != null) { 
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row4HashKey.CD_PRODUIT = produitsToInsert.CD_PRODUIT ;
...
! produitsToInsert.NOM_PRODUIT.equals(row4.NOM_PRODUIT) || 
 produitsToInsert.PRIX_ACHAT_PRODUIT.compareTo(row4.PRIX_ACHAT_PRODUIT )!=0 || produitsToInsert.PRIX_VENTE_PRODUIT.compareTo(row4.PRIX_VENTE_PRODUIT )!=0 ||
!produitsToInsert.CD_SOUS_CATEGORIE.equals(row4.CD_SOUS_CATEGORIE) ||
!produitsToInsert.LB_SOUS_CATEGORIE.equals(row4.LB_SOUS_CATEGORIE) ||
!produitsToInsert.CD_CATEGORIE.equals(row4.CD_CATEGORIE) ||
!produitsToInsert.LB_CATEGORIE.equals(row4.LB_CATEGORIE)

 ) {
updateBlcurrent_tmp.ID_DIM_PRODUIT = row4.ID_DIM_PRODUIT ;
...
insertNewProduit_tmp.CD_PRODUIT = produitsToInsert.CD_PRODUIT  ;
insertNewProduit_tmp.NOM_PRODUIT = produitsToInsert.NOM_PRODUIT  ;
insertNewProduit_tmp.PRIX_ACHAT_PRODUIT = produitsToInsert.PRIX_ACHAT_PRODUIT  ;
insertNewProduit_tmp.PRIX_VENTE_PRODUIT = produitsToInsert.PRIX_VENTE_PRODUIT  ;
insertNewProduit_tmp.CD_SOUS_CATEGORIE = produitsToInsert.CD_SOUS_CATEGORIE  ;
insertNewProduit_tmp.LB_SOUS_CATEGORIE = produitsToInsert.LB_SOUS_CATEGORIE  ;
insertNewProduit_tmp.LB_CATEGORIE = produitsToInsert.LB_CATEGORIE  ;
insertNewProduit_tmp.DT_INSERTION = TalendDate.getCurrentDate();
insertNewProduit_tmp.BL_LIGNE_ACTIVE = 1 ;
insertNewProduit_tmp.LB_JOB_NAME = produitsToInsert.LB_JOB_NAME  ;
insertNewProduit = insertNewProduit_tmp;
} // closing filter/reject
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'insertProduitDWH'
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
insertProduitDWH_tmp.CD_PRODUIT = produitsToInsert.CD_PRODUIT ;
insertProduitDWH_tmp.NOM_PRODUIT = produitsToInsert.NOM_PRODUIT ;
insertProduitDWH_tmp.PRIX_ACHAT_PRODUIT = produitsToInsert.PRIX_ACHAT_PRODUIT ;
insertProduitDWH_tmp.PRIX_VENTE_PRODUIT = produitsToInsert.PRIX_VENTE_PRODUIT ;
insertProduitDWH_tmp.CD_SOUS_CATEGORIE = produitsToInsert.CD_SOUS_CATEGORIE ;
insertProduitDWH_tmp.LB_SOUS_CATEGORIE = produitsToInsert.LB_SOUS_CATEGORIE ;
insertProduitDWH_tmp.LB_CATEGORIE = produitsToInsert.LB_CATEGORIE ;
insertProduitDWH_tmp.DT_INSERTION = TalendDate.getCurrentDate();
insertProduitDWH_tmp.BL_LIGNE_ACTIVE = 1;
insertProduitDWH_tmp.LB_JOB_NAME = produitsToInsert.LB_JOB_NAME ;
insertProduitDWH_tmp.CD_CATEGORIE = produitsToInsert.CD_CATEGORIE ;
insertProduitDWH = insertProduitDWH_tmp;
} // closing filter/reject
// ###############################
 ...
 */
// Start of branch "insertProduitDWH"
if(insertProduitDWH != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(insertProduitDWH.CD_PRODUIT == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, insertProduitDWH.CD_PRODUIT);
}

                    if(insertProduitDWH.NOM_PRODUIT == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, insertProduitDWH.NOM_PRODUIT);
}

                    pstmt_tDBOutput_1.setBigDecimal(3, insertProduitDWH.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_1.setBigDecimal(4, insertProduitDWH.PRIX_VENTE_PRODUIT);

                    if(insertProduitDWH.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, insertProduitDWH.CD_SOUS_CATEGORIE);
}

                    if(insertProduitDWH.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, insertProduitDWH.LB_SOUS_CATEGORIE);
}

                    if(insertProduitDWH.LB_CATEGORIE == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, insertProduitDWH.LB_CATEGORIE);
}

                    if(insertProduitDWH.DT_INSERTION != null) {
pstmt_tDBOutput_1.setTimestamp(8, new java.sql.Timestamp(insertProduitDWH.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.TIMESTAMP);
}

                    if(insertProduitDWH.BL_LIGNE_ACTIVE == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(9, insertProduitDWH.BL_LIGNE_ACTIVE);
}

                    if(insertProduitDWH.LB_JOB_NAME == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, insertProduitDWH.LB_JOB_NAME);
}

                    if(insertProduitDWH.CD_CATEGORIE == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, insertProduitDWH.CD_CATEGORIE);
}
...
} // End of branch "insertProduitDWH"
...
} else {pstmt_tDBOutput_3.setString(7, insertNewProduit.LB_CATEGORIE);
}

                    if(insertNewProduit.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(8, new java.sql.Timestamp(insertNewProduit.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(8, java.sql.Types.TIMESTAMP);
}

                    if(insertNewProduit.BL_LIGNE_ACTIVE == null) {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(9, insertNewProduit.BL_LIGNE_ACTIVE);
}

                    if(insertNewProduit.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(10, insertNewProduit.LB_JOB_NAME);
}
...
} // End of branch "produitsToInsert"
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"produitsToInsert");
			  	}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertProduitDWH");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2,row3) outputs:(produitsToInsert)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(produitsToInsert,row4) outputs:(insertProduitDWH,updateBlcurrent,insertNewProduit)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jDwhProduit.class.getClassLoader().getResourceAsStream("adw/jdwhproduit_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     283955 characters generated by Talend Open Studio for Data Integration 
