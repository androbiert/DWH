...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ADW_jDwhVente = new byte[0];
    static byte[] commonByteArray_ADW_jDwhVente = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADW_jDwhVente.length) {
				if(length < 1024 && commonByteArray_ADW_jDwhVente.length == 0) {
   					commonByteArray_ADW_jDwhVente = new byte[1024];
				} else {
   					commonByteArray_ADW_jDwhVente = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADW_jDwhVente, 0, length);
			strReturn = new String(commonByteArray_ADW_jDwhVente, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ADW_jDwhVente, 0, length);
			strReturn = new String(commonByteArray_ADW_jDwhVente, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADW_jDwhVente) {
 ...
 */
	...
	final String decryptedPassword_Implicit_Context_Database = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:6UMUPbZfiJTtyKkcja+2YYBxdMeP9SJO56lGgkiu+QX6Bj9P");
...
public static class venteTiInsertStruct implements routines.system.IPersistableRow<venteTiInsertStruct> {
    final static byte[] commonByteArrayLock_ADW_jDwhVente = new byte[0];
    static byte[] commonByteArray_ADW_jDwhVente = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final venteTiInsertStruct other = (venteTiInsertStruct) obj;
	...
	public void copyDataTo(venteTiInsertStruct other) {
	...
	public void copyKeysDataTo(venteTiInsertStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(venteTiInsertStruct other) {
...
venteTiInsertStruct venteTiInsert = new venteTiInsertStruct();
	...
	currentComponent="tHashOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"venteTiInsert");
					}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<venteTiInsertStruct> tHashFile_tHashOutput_1 = null;
		String hashKey_tHashOutput_1 = "tHashFile_jDwhVente_" + pid + "_tHashOutput_1";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_1)){
			    if(mf_tHashOutput_1.getResourceMap().get(hashKey_tHashOutput_1) == null){
	      		    mf_tHashOutput_1.getResourceMap().put(hashKey_tHashOutput_1, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<venteTiInsertStruct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
...
venteTiInsertStruct venteTiInsert_tmp = new venteTiInsertStruct();
// ###############################
...
// # Output table : 'venteTiInsert'
venteTiInsert_tmp.ID_DIM_PRODUIT = row2.ID_DIM_PRODUIT ;
venteTiInsert_tmp.ID_DIM_CLIENT = row4.ID_DIM_CLIENT ;
venteTiInsert_tmp.ID_DIM_CALENDRIER = row3.ID_DIM_CALENDRIER ;
venteTiInsert_tmp.ID_VENTE = row1.ID_VENTE ;
venteTiInsert_tmp.QTE_VENTE = row1.QTE_VENTE ;
venteTiInsert_tmp.MT_ACHAT = row1.QTE_VENTE *  row1.PRIX_ACHAT ;
venteTiInsert_tmp.MT_VENTE = row1.QTE_VENTE *  row1.PRIX_VENTE ;
venteTiInsert_tmp.CD_PRODUIT = row1.CD_PRODUIT ;
venteTiInsert_tmp.ID_CLIENT = row1.ID_CLIENT ;
venteTiInsert = venteTiInsert_tmp;
 ...
 */
// Start of branch "venteTiInsert"
if(venteTiInsert != null) { 
	...
	currentComponent="tHashOutput_1";
		...
		venteTiInsertStruct oneRow_tHashOutput_1 = new venteTiInsertStruct();
				
					oneRow_tHashOutput_1.ID_DIM_PRODUIT = venteTiInsert.ID_DIM_PRODUIT;
					oneRow_tHashOutput_1.ID_DIM_CLIENT = venteTiInsert.ID_DIM_CLIENT;
					oneRow_tHashOutput_1.ID_DIM_CALENDRIER = venteTiInsert.ID_DIM_CALENDRIER;
					oneRow_tHashOutput_1.ID_VENTE = venteTiInsert.ID_VENTE;
					oneRow_tHashOutput_1.QTE_VENTE = venteTiInsert.QTE_VENTE;
					oneRow_tHashOutput_1.MT_ACHAT = venteTiInsert.MT_ACHAT;
					oneRow_tHashOutput_1.MT_VENTE = venteTiInsert.MT_VENTE;
					oneRow_tHashOutput_1.CD_PRODUIT = venteTiInsert.CD_PRODUIT;
					oneRow_tHashOutput_1.ID_CLIENT = venteTiInsert.ID_CLIENT;
...
globalMap.put("tHashOutput_1_NB_LINE", nb_line_tHashOutput_1);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"venteTiInsert");
			  	}
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<venteTiInsertStruct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_jDwhVente_" + pid +"_tHashOutput_1");
if(tHashFile_tHashInput_1==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<venteTiInsertStruct> iterator_tHashInput_1 = tHashFile_tHashInput_1.iterator();
while (iterator_tHashInput_1.hasNext()) {
    venteTiInsertStruct next_tHashInput_1 = iterator_tHashInput_1.next();
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		hash_tAggregateRow_1.put(operation_result_tAggregateRow_1, operation_result_tAggregateRow_1);
				...
				operation_result_tAggregateRow_1.count++;
					...
					if( row5.QTE_VENTE != null)
						operation_result_tAggregateRow_1.NB_QTE_VENTE_sum += row5.QTE_VENTE;
				...
				operation_result_tAggregateRow_1.NB_MT_VENTE_clmCount++;
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row6.NB_VENTE = (int) aggregated_row_tAggregateRow_1.count;
	                                	...
	                                	row6.NB_QTE_VENTE = aggregated_row_tAggregateRow_1.NB_QTE_VENTE_sum;
                                	
    								if(aggregated_row_tAggregateRow_1.NB_MT_ACHAT_sum != null) {
    								row6.NB_MT_ACHAT = aggregated_row_tAggregateRow_1.NB_MT_ACHAT_sum.doubleValue();
										
    								}else{
    								
    									row6.NB_MT_ACHAT = null;
    									
    								}
    								row6.NB_MT_VENTE = (double) aggregated_row_tAggregateRow_1.count;
	                                	row6.NB_MT_VENTE = (double) aggregated_row_tAggregateRow_1.NB_MT_VENTE_clmCount;
...
insertVente_tmp.NB_QTE_VENTE = row6.NB_QTE_VENTE ;
insertVente_tmp.NB_MT_ACHAT = row6.NB_MT_ACHAT ;
insertVente_tmp.NB_MT_VENTE = row6.NB_MT_VENTE ;
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<venteTiInsertStruct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_jDwhVente_" + pid +"_tHashOutput_1");
if(tHashFile_tHashInput_2==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<venteTiInsertStruct> iterator_tHashInput_2 = tHashFile_tHashInput_2.iterator();
while (iterator_tHashInput_2.hasNext()) {
    venteTiInsertStruct next_tHashInput_2 = iterator_tHashInput_2.next();
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row4) outputs:(venteTiInsert)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jDwhVente.class.getClassLoader().getResourceAsStream("adw/jdwhvente_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     347537 characters generated by Talend Open Studio for Data Integration 
 *     on the 3 juin 2025 à 3:25:23 AM WAT
 ************************************************************************************************/