...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ADW_jOdsCategorie = new byte[0];
    static byte[] commonByteArray_ADW_jOdsCategorie = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADW_jOdsCategorie.length) {
				if(length < 1024 && commonByteArray_ADW_jOdsCategorie.length == 0) {
   					commonByteArray_ADW_jOdsCategorie = new byte[1024];
				} else {
   					commonByteArray_ADW_jOdsCategorie = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADW_jOdsCategorie, 0, length);
			strReturn = new String(commonByteArray_ADW_jOdsCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ADW_jOdsCategorie, 0, length);
			strReturn = new String(commonByteArray_ADW_jOdsCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADW_jOdsCategorie) {
 ...
 */
	...
	final String decryptedPassword_Implicit_Context_Database = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:JsAXez3LWwHOO9mfDAW+/jtx5n0Gavzh5EvG077TApW1cDsk");
...
if(Categorie != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((! Categorie.CD_CATEGORIE.isEmpty() && ! Categorie.LB_CATEGORIE.isEmpty()), "advanced condition failed");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jOdsCategorie.class.getClassLoader().getResourceAsStream("adw/jodscategorie_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     313232 characters generated by Talend Open Studio for Data Integration 
