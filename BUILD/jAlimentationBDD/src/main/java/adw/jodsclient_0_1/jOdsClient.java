...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ADW_jOdsClient = new byte[0];
    static byte[] commonByteArray_ADW_jOdsClient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADW_jOdsClient.length) {
				if(length < 1024 && commonByteArray_ADW_jOdsClient.length == 0) {
   					commonByteArray_ADW_jOdsClient = new byte[1024];
				} else {
   					commonByteArray_ADW_jOdsClient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADW_jOdsClient, 0, length);
			strReturn = new String(commonByteArray_ADW_jOdsClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ADW_jOdsClient, 0, length);
			strReturn = new String(commonByteArray_ADW_jOdsClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADW_jOdsClient) {
 ...
 */
	...
	final String decryptedPassword_Implicit_Context_Database = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:augQKsQuxyaDcFfccuMgUBLDFR0KcPyPurvDsBdnFiQ/Zpcq");
...
public static class TypeClientInexistantStruct implements routines.system.IPersistableRow<TypeClientInexistantStruct> {
    final static byte[] commonByteArrayLock_ADW_jOdsClient = new byte[0];
    static byte[] commonByteArray_ADW_jOdsClient = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final TypeClientInexistantStruct other = (TypeClientInexistantStruct) obj;
	...
	public void copyDataTo(TypeClientInexistantStruct other) {
	...
	public void copyKeysDataTo(TypeClientInexistantStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(TypeClientInexistantStruct other) {
...
TypeClientInexistantStruct TypeClientInexistant = new TypeClientInexistantStruct();
 ...
 */
	...
	currentComponent="tDBOutput_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"TypeClientInexistant");
					}
...
TypeClientInexistantStruct TypeClientInexistant_tmp = new TypeClientInexistantStruct();
// ###############################
...
! clients.CD_TYPE_CLIENT.isEmpty()), "advanced condition failed");
      ...
      nb_line_ok_tFilterRow_1++;
            ...
            if (row6 == null){
              row6 = new row6Struct();
                ...
                row6.ID_CLIENT = clients.ID_CLIENT;
                row6.NOM_CLIENT = clients.NOM_CLIENT;
                row6.PREN_CLIENT = clients.PREN_CLIENT;
                row6.CD_POSTAL_CLIENT = clients.CD_POSTAL_CLIENT;
                row6.VILLE_CLIENT = clients.VILLE_CLIENT;
                row6.PAYS_CLIENT = clients.PAYS_CLIENT;
                row6.REGION_CLIENT = clients.REGION_CLIENT;
                row6.CD_TYPE_CLIENT = clients.CD_TYPE_CLIENT;
                row6.NUM_LIGNE = clients.NUM_LIGNE;
...
if(row7 == null){ 
	...
	row7 = new row7Struct();
}				row7.ID_CLIENT = row2.ID_CLIENT;			row7.NOM_CLIENT = row2.NOM_CLIENT;			row7.PREN_CLIENT = row2.PREN_CLIENT;			row7.CD_POSTAL_CLIENT = row2.CD_POSTAL_CLIENT;			row7.VILLE_CLIENT = row2.VILLE_CLIENT;			row7.PAYS_CLIENT = row2.PAYS_CLIENT;			row7.REGION_CLIENT = row2.REGION_CLIENT;			row7.CD_TYPE_CLIENT = row2.CD_TYPE_CLIENT;			row7.NUM_LIGNE = row2.NUM_LIGNE;			
...
// # Output reject table : 'TypeClientInexistant'
// # Filter conditions 
if( rejectedInnerJoin_tMap_4 ) {
TypeClientInexistant_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
TypeClientInexistant_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
TypeClientInexistant_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE ;
TypeClientInexistant_tmp.LB_LIGNE_REJET = row3.ID_CLIENT +'|'+ row3.NOM_CLIENT  +'|'+ row3.PREN_CLIENT ;
TypeClientInexistant_tmp.LB_MESSAGE_REJET = "Dependance ==> au type client : " +  row3.CD_TYPE_CLIENT + " n'existe pas dans la table ODS_TYPE_CLIENT" ;
TypeClientInexistant_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
TypeClientInexistant_tmp.DT_REJET = TalendDate.getCurrentDate() ;
TypeClientInexistant_tmp.LB_JOB_NAME = jobName;
TypeClientInexistant = TypeClientInexistant_tmp;
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row5HashKey.ID_CLIENT = client.ID_CLIENT ;
...
! client.NOM_CLIENT.equals(row5.NOM_CLIENT)||
!client.PREN_CLIENT.equals(row5.PREN_CLIENT) ||
!client.CD_POSTAL_CLIENT.equals(row5.CD_POSTAL_CLIENT)|| 
 !client.VILLE_CLIENT.equals(row5.VILLE_CLIENT) ||!client.PAYS_CLIENT.equals(row5.PAYS_CLIENT) ||! client.REGION_CLIENT.equals(row5.REGION_CLIENT) ||
! client.CD_TYPE_CLIENT.equals(row5.CD_TYPE_CLIENT)

 ) {
updateClient_tmp.ID_CLIENT = client.ID_CLIENT ;
...
// Start of branch "TypeClientInexistant"
if(TypeClientInexistant != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(TypeClientInexistant.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, TypeClientInexistant.LB_CHEMIN_FICHIER);
}

                    if(TypeClientInexistant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, TypeClientInexistant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_3.setInt(3, TypeClientInexistant.NUM_LIGNE_REJET);

                    if(TypeClientInexistant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, TypeClientInexistant.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_3 > 0) {
                        if(TypeClientInexistant.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(1, TypeClientInexistant.LB_MESSAGE_REJET);
}

                        if(TypeClientInexistant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(2, TypeClientInexistant.LB_NOM_FLUX);
}

                        if(TypeClientInexistant.DT_REJET != null) {
pstmtUpdate_tDBOutput_3.setTimestamp(3, new java.sql.Timestamp(TypeClientInexistant.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_3.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(TypeClientInexistant.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(4, TypeClientInexistant.LB_JOB_NAME);
}

                        if(TypeClientInexistant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(5 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(5 + count_tDBOutput_3, TypeClientInexistant.LB_CHEMIN_FICHIER);
}

                        if(TypeClientInexistant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(6 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(6 + count_tDBOutput_3, TypeClientInexistant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_3.setInt(7 + count_tDBOutput_3, TypeClientInexistant.NUM_LIGNE_REJET);

                        if(TypeClientInexistant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_3.setNull(8 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(8 + count_tDBOutput_3, TypeClientInexistant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_3.setString(1, TypeClientInexistant.LB_CHEMIN_FICHIER);
}

                        if(TypeClientInexistant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(2, TypeClientInexistant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_3.setInt(3, TypeClientInexistant.NUM_LIGNE_REJET);

                        if(TypeClientInexistant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(4, TypeClientInexistant.LB_LIGNE_REJET);
}

                        if(TypeClientInexistant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(5, TypeClientInexistant.LB_MESSAGE_REJET);
}

                        if(TypeClientInexistant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(6, TypeClientInexistant.LB_NOM_FLUX);
}

                        if(TypeClientInexistant.DT_REJET != null) {
pstmtInsert_tDBOutput_3.setTimestamp(7, new java.sql.Timestamp(TypeClientInexistant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_3.setString(8, TypeClientInexistant.LB_JOB_NAME);
}
...
} // End of branch "TypeClientInexistant"
...
insertDuplicate_tmp.LB_LIGNE_REJET = row7.ID_CLIENT +'|'+ row7.NOM_CLIENT  +'|'+ row7.PREN_CLIENT ;
...
insertReject_tmp.LB_LIGNE_REJET = row6.ID_CLIENT +'|'+row6.NOM_CLIENT 
+'|'+
 row6.PREN_CLIENT ;
 ...
 */
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"TypeClientInexistant");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(client,row5) outputs:(insertClient,updateClient,insertNewClient)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_4 - inputs:(row3,row4) outputs:(client,TypeClientInexistant)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jOdsClient.class.getClassLoader().getResourceAsStream("adw/jodsclient_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     414648 characters generated by Talend Open Studio for Data Integration 
