...
package adw.jodssouscategorie_0_1;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ADW_jOdsSousCategorie = new byte[0];
    static byte[] commonByteArray_ADW_jOdsSousCategorie = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADW_jOdsSousCategorie.length) {
				if(length < 1024 && commonByteArray_ADW_jOdsSousCategorie.length == 0) {
   					commonByteArray_ADW_jOdsSousCategorie = new byte[1024];
				} else {
   					commonByteArray_ADW_jOdsSousCategorie = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADW_jOdsSousCategorie, 0, length);
			strReturn = new String(commonByteArray_ADW_jOdsSousCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ADW_jOdsSousCategorie, 0, length);
			strReturn = new String(commonByteArray_ADW_jOdsSousCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADW_jOdsSousCategorie) {
 ...
 */
	...
	final String decryptedPassword_Implicit_Context_Database = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:9tcQ9CXbhORyYrpsHtVGQXP8CFL8vcXdjPneRr1g/TmduakA");
...
public static class inserNewValueSousCategorieStruct implements routines.system.IPersistableRow<inserNewValueSousCategorieStruct> {
    final static byte[] commonByteArrayLock_ADW_jOdsSousCategorie = new byte[0];
    static byte[] commonByteArray_ADW_jOdsSousCategorie = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final inserNewValueSousCategorieStruct other = (inserNewValueSousCategorieStruct) obj;
	...
	public void copyDataTo(inserNewValueSousCategorieStruct other) {
	...
	public void copyKeysDataTo(inserNewValueSousCategorieStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(inserNewValueSousCategorieStruct other) {
...
inserNewValueSousCategorieStruct inserNewValueSousCategorie = new inserNewValueSousCategorieStruct();
 ...
 */
	...
	currentComponent="tDBOutput_5";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"inserNewValueSousCategorie");
					}
...
inserNewValueSousCategorieStruct inserNewValueSousCategorie_tmp = new inserNewValueSousCategorieStruct();
// ###############################
...
if(sous_categorie != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((! sous_categorie.CD_CATEGORIE.isEmpty() && ! sous_categorie.LB_SOUS_CATEGORIE.isEmpty() &&
! sous_categorie.CD_SOUS_CATEGORIE.isEmpty()), "advanced condition failed");
      ...
      nb_line_ok_tFilterRow_1++;
            ...
            if (row5 == null){
              row5 = new row5Struct();
                ...
                row5.CD_SOUS_CATEGORIE = sous_categorie.CD_SOUS_CATEGORIE;
                row5.LB_SOUS_CATEGORIE = sous_categorie.LB_SOUS_CATEGORIE;
                row5.CD_CATEGORIE = sous_categorie.CD_CATEGORIE;
                row5.NUM_LIGNE = sous_categorie.NUM_LIGNE;
...
categorieManquant_tmp.LB_MESSAGE_REJET = " Depedance de la ==> " + row3.CD_CATEGORIE + "n'existe pas dans la table CATEGORIE" ;
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.CD_SOUS_CATEGORIE = sousCategories.CD_SOUS_CATEGORIE ;
...
inserNewValueSousCategorie = null;
...
!sousCategories.LB_SOUS_CATEGORIE.equals(row7.LB_SOUS_CATEGORIE) || !sousCategories.CD_CATEGORIE.equals(row7.CD_CATEGORIE)

 ) {
updateBlcurrent_tmp.CD_SOUS_CATEGORIE = sousCategories.CD_SOUS_CATEGORIE ;
updateBlcurrent_tmp.LB_SOUS_CATEGORIE = null;
updateBlcurrent_tmp.CD_CATEGORIE = null;
...
// # Output table : 'inserNewValueSousCategorie'
// # Filter conditions 
if( 
...
inserNewValueSousCategorie_tmp.CD_SOUS_CATEGORIE = sousCategories.CD_SOUS_CATEGORIE ;
inserNewValueSousCategorie_tmp.LB_SOUS_CATEGORIE = sousCategories.LB_SOUS_CATEGORIE ;
inserNewValueSousCategorie_tmp.CD_CATEGORIE = sousCategories.CD_CATEGORIE ;
inserNewValueSousCategorie_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
inserNewValueSousCategorie_tmp.DT_INSERTION = TalendDate.getCurrentDate() ;
inserNewValueSousCategorie_tmp.BL_LIGNE_ACTIVE = 1;
inserNewValueSousCategorie_tmp.LB_JOB_NAME = jobName;
inserNewValueSousCategorie = inserNewValueSousCategorie_tmp;
} // closing filter/reject
} // closing inner join bracket (1)
// ###### START REJECTS ##### 
...
} else {pstmt_tDBOutput_4.setString(1, updateBlcurrent.LB_SOUS_CATEGORIE);
}

                    if(updateBlcurrent.CD_CATEGORIE == null) {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2, updateBlcurrent.CD_CATEGORIE);
}

                    if(updateBlcurrent.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(3, updateBlcurrent.LB_NOM_FICHIER);
}

                    if(updateBlcurrent.DT_INSERTION != null) {
pstmt_tDBOutput_4.setTimestamp(4, new java.sql.Timestamp(updateBlcurrent.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_4.setNull(4, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_4.setInt(5, updateBlcurrent.BL_LIGNE_ACTIVE);

                    if(updateBlcurrent.LB_JOB_NAME == null) {
pstmt_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(6, updateBlcurrent.LB_JOB_NAME);
}

                    if(updateBlcurrent.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_4.setNull(7 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(7 + count_tDBOutput_4, updateBlcurrent.CD_SOUS_CATEGORIE);
}
...
// Start of branch "inserNewValueSousCategorie"
if(inserNewValueSousCategorie != null) { 
	...
	currentComponent="tDBOutput_5";
        ...
        whetherReject_tDBOutput_5 = false;
                    if(inserNewValueSousCategorie.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_5.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(1, inserNewValueSousCategorie.CD_SOUS_CATEGORIE);
}

                    if(inserNewValueSousCategorie.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(2, inserNewValueSousCategorie.LB_SOUS_CATEGORIE);
}

                    if(inserNewValueSousCategorie.CD_CATEGORIE == null) {
pstmt_tDBOutput_5.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(3, inserNewValueSousCategorie.CD_CATEGORIE);
}

                    if(inserNewValueSousCategorie.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_5.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(4, inserNewValueSousCategorie.LB_NOM_FICHIER);
}

                    if(inserNewValueSousCategorie.DT_INSERTION != null) {
pstmt_tDBOutput_5.setTimestamp(5, new java.sql.Timestamp(inserNewValueSousCategorie.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_5.setNull(5, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_5.setInt(6, inserNewValueSousCategorie.BL_LIGNE_ACTIVE);

                    if(inserNewValueSousCategorie.LB_JOB_NAME == null) {
pstmt_tDBOutput_5.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(7, inserNewValueSousCategorie.LB_JOB_NAME);
}
...
} // End of branch "inserNewValueSousCategorie"
...
} else {pstmt_tDBOutput_6.setString(1, categorieManquant.LB_CHEMIN_FICHIER);
}

                    if(categorieManquant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, categorieManquant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_6.setInt(3, categorieManquant.NUM_LIGNE_REJET);

                    if(categorieManquant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(4, categorieManquant.LB_LIGNE_REJET);
}
...
} else {pstmtUpdate_tDBOutput_6.setString(1, categorieManquant.LB_MESSAGE_REJET);
}

                        if(categorieManquant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(2, categorieManquant.LB_NOM_FLUX);
}

                        if(categorieManquant.DT_REJET != null) {
pstmtUpdate_tDBOutput_6.setTimestamp(3, new java.sql.Timestamp(categorieManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_6.setString(4, categorieManquant.LB_JOB_NAME);
}

                        if(categorieManquant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_6.setNull(5 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(5 + count_tDBOutput_6, categorieManquant.LB_CHEMIN_FICHIER);
}

                        if(categorieManquant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_6.setNull(6 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(6 + count_tDBOutput_6, categorieManquant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_6.setInt(7 + count_tDBOutput_6, categorieManquant.NUM_LIGNE_REJET);

                        if(categorieManquant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_6.setNull(8 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(8 + count_tDBOutput_6, categorieManquant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_6.setString(1, categorieManquant.LB_CHEMIN_FICHIER);
}

                        if(categorieManquant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(2, categorieManquant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_6.setInt(3, categorieManquant.NUM_LIGNE_REJET);

                        if(categorieManquant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(4, categorieManquant.LB_LIGNE_REJET);
}

                        if(categorieManquant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(5, categorieManquant.LB_MESSAGE_REJET);
}

                        if(categorieManquant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(6, categorieManquant.LB_NOM_FLUX);
}

                        if(categorieManquant.DT_REJET != null) {
pstmtInsert_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(categorieManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_6.setString(8, categorieManquant.LB_JOB_NAME);
}
...
insertDuplicate_tmp.LB_LIGNE_REJET = row6.CD_CATEGORIE +'|'+  row6.LB_SOUS_CATEGORIE +'|'+row6.CD_SOUS_CATEGORIE   ;
...
insertReject_tmp.LB_LIGNE_REJET = row5.CD_CATEGORIE +'|'+  row5.LB_SOUS_CATEGORIE +'|'+row5.CD_SOUS_CATEGORIE  ;
...
globalMap.put("tDBOutput_5_ERROR_MESSAGE",e_tDBOutput_5.getMessage());
	...
	nb_line_rejected_tDBOutput_5=nb_line_rejected_tDBOutput_5 + rejectedCount_tDBOutput_5;
        ...
        globalMap.put("tDBOutput_5_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_5);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"inserNewValueSousCategorie");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_3 - inputs:(row3,row4) outputs:(sousCategories,categorieManquant)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(sousCategories,row7) outputs:(insertSousCategorie,updateBlcurrent,inserNewValueSousCategorie)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jOdsSousCategorie.class.getClassLoader().getResourceAsStream("adw/jodssouscategorie_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     385502 characters generated by Talend Open Studio for Data Integration 
 *     on the 3 juin 2025 à 3:25:20 AM WAT
 ************************************************************************************************/