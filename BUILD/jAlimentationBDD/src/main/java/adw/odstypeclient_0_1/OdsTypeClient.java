...
/**
 * Job: OdsTypeClient Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class OdsTypeClient implements TalendJob {
...
public String getFieldSeparator(){
	...
	private final String jobName = "OdsTypeClient";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				OdsTypeClient.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(OdsTypeClient.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ADW_OdsTypeClient = new byte[0];
    static byte[] commonByteArray_ADW_OdsTypeClient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADW_OdsTypeClient.length) {
				if(length < 1024 && commonByteArray_ADW_OdsTypeClient.length == 0) {
   					commonByteArray_ADW_OdsTypeClient = new byte[1024];
				} else {
   					commonByteArray_ADW_OdsTypeClient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADW_OdsTypeClient, 0, length);
			strReturn = new String(commonByteArray_ADW_OdsTypeClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ADW_OdsTypeClient, 0, length);
			strReturn = new String(commonByteArray_ADW_OdsTypeClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADW_OdsTypeClient) {
 ...
 */
	...
	final String decryptedPassword_Implicit_Context_Database = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:HCuPiYw3SUYdZQOxJArQ2y01oplo81xGzLJNafgKCnOYrmqF");
...
int count_tDBOutput_3=0;
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"LB_TYPE_CLIENT\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_TYPE_CLIENT\" = ?";
...
if(TypeClient != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((! TypeClient.CD_TYPE_CLIENT.isEmpty() && ! TypeClient.LB_TYPE_CLIENT.isEmpty()), "advanced condition failed");
...
updateBLcurrent_tmp.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT ;
updateBLcurrent_tmp.LB_TYPE_CLIENT = null;
updateBLcurrent_tmp.LB_NOM_FICHIER = null;
updateBLcurrent_tmp.DT_INSERTION = null;
updateBLcurrent_tmp.BL_LIGNE_ACTIVE = 0;
updateBLcurrent_tmp.LB_JOB_NAME = jobName;
...
if(updateBLcurrent != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(updateBLcurrent.LB_TYPE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, updateBLcurrent.LB_TYPE_CLIENT);
}

                    if(updateBLcurrent.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, updateBLcurrent.LB_NOM_FICHIER);
}

                    if(updateBLcurrent.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(3, new java.sql.Timestamp(updateBLcurrent.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_3.setInt(4, updateBLcurrent.BL_LIGNE_ACTIVE);

                    if(updateBLcurrent.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, updateBLcurrent.LB_JOB_NAME);
}

                    if(updateBLcurrent.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(6 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6 + count_tDBOutput_3, updateBLcurrent.CD_TYPE_CLIENT);
}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row3,row4) outputs:(insertTypeClient,updateBLcurrent,insertNewValueTypeClient)
 ...
 */
    ...
    public static void main(String[] args){
        final OdsTypeClient OdsTypeClientClass = new OdsTypeClient();

        int exitCode = OdsTypeClientClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = OdsTypeClient.class.getClassLoader().getResourceAsStream("adw/odstypeclient_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = OdsTypeClient.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : OdsTypeClient");
        }
...
/************************************************************************************************
 *     314060 characters generated by Talend Open Studio for Data Integration 
